...
export const ENRICHED_BRANDS = [
  {
    ...
    story: "For over 150 years, Pillsbury has set the global standard for baking ingredients. Since partnering with Shreepathy & Co, we have brought their professional range of cake and bread premixes to bakeries across Karnataka, ensuring consistency and taste at scale.",
  ...
  },
  {
    ...
    story: "Rich Products Corporation pioneered the non-dairy whipping cream industry in 1945. Today, their products are synonymous with cake decoration excellence. We distribute Rich's range of high-performance toppings to premium bakeries throughout Karnataka.",
  ...
  },
  {
    ...
    story: "Monin has been crafting gourmet syrups and fruit preparations in France for over a century. Known globally as the choice of top bartenders and baristas, Monin syrups elevate beverages in the finest cafes and hotels in Karnataka.",
  ...
  },
  {
    ...
    story: "McCain Foods is the world's largest manufacturer of frozen potato products. From multi-national fast food chains to local cafes, McCain French fries are the preferred choice for crispiness and shelf holding. We distribute McCain products across Karnataka.",
